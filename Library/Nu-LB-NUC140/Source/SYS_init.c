...
//    CLK_SetModuleClock(RTC_MODULE, CLK_CLKSEL2_RTC_SEL_10K_LXT, 0);	
    ...
    SYS->GPB_MFP = (SYS->GPB_MFP & ~SYS_PB_H_MFP_PB15_MFP_Msk) | SYS_PB_H_MFP_PB15_MFP_EINT1;
		 ...
		 // FIXME: Added by Jorden Huang
		 SYS->ALT_MFP = (SYS->ALT_MFP & ~SYS_ALT_MFP_PC0_Msk) | SYS_ALT_MFP_PC0_I2SLRCLK_Msk;
		 #endif
		 #ifdef PIN_I2S_BCLK_PC1
		 SYS->GPC_MFP = (SYS->GPC_MFP & ~SYS_PC_L_MFP_PC1_MFP_Msk) | SYS_PC_L_MFP_PC1_MFP_I2S_BCLK;
		 // FIXME: Added by Jorden Huang
		 SYS->ALT_MFP = (SYS->ALT_MFP & ~SYS_ALT_MFP_PC1_Msk) | SYS_ALT_MFP_PC1_I2SBCLK_Msk;
		 #endif
		 #ifdef PIN_I2S_DI_PC2
		 SYS->GPC_MFP = (SYS->GPC_MFP & ~SYS_PC_L_MFP_PC2_MFP_Msk) | SYS_PC_L_MFP_PC2_MFP_I2S_DI;
		 // FIXME: Added by Jorden Huang
		 SYS->ALT_MFP = (SYS->ALT_MFP & ~SYS_ALT_MFP_PC2_Msk) | SYS_ALT_MFP_PC2_I2SDI_Msk;
		 #endif	
		 #ifdef PIN_I2S_DI_PC3
		 SYS->GPC_MFP = (SYS->GPC_MFP & ~SYS_PC_L_MFP_PC3_MFP_Msk) | SYS_PC_L_MFP_PC3_MFP_I2S_DO;
		 // FIXME: Added by Jorden Huang
		 SYS->ALT_MFP = (SYS->ALT_MFP & ~SYS_ALT_MFP_PC3_Msk) | SYS_ALT_MFP_PC3_I2SDO_Msk;
		 #endif	
		 // FIXME: Added by Jorden Huang
		#ifdef PIN_I2S_MCLK_PA15
		 SYS->GPA_MFP = (SYS->GPA_MFP & ~SYS_PA_H_MFP_PA15_MFP_Msk) | SYS_PA_H_MFP_PA15_MFP_I2S_MCLK;
		 SYS->ALT_MFP = (SYS->ALT_MFP & ~SYS_ALT_MFP_PA15_Msk) | SYS_ALT_MFP_PA15_I2S_MCLK;
		#endif
		#endif
